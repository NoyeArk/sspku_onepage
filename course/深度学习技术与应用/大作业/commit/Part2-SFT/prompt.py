...
# coding: utf-8
# =============================================================================
# Part 3 — Prompting: HotpotQA 多跳问答推理 + 评测（vLLM 加速版）
...
MODEL_PATH = f"/mnt/workspace/{USER}/openPangu-Embedded-7B-V1.1/mg2hf"
DATA_PATH = os.path.join(BASE_DIR, "hotpot_qa", "hotpot_test_v1.json")

# 输出路径
OUTPUT_DIR = f"/mnt/workspace/{USER}/experiment_openPangu/openPangu7B-Prompt/sft_output"
