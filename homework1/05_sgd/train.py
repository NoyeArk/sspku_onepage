"""
实验 5：随机梯度下降（SGD）——小批量（minibatch）随机打乱后按 batch 更新。
...
from nn_numpy import MLPNumpy, accuracy, load_mnist, train_epoch_sgd, build_optimizer_state
...
def main() -> None:
    ...
    ax.set_title("SGD（小批量随机梯度下降，batch=128）")
    fig.tight_layout()
